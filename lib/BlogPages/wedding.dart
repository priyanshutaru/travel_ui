...
class BlogWedding extends StatefulWidget {
  const BlogWedding({super.key});

  @override
  State<BlogWedding> createState() => _BlogWeddingState();
}

class _BlogWeddingState extends State<BlogWedding> {
  @override
