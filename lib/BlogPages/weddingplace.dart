...
class BlogWeddingPlace extends StatefulWidget {
  const BlogWeddingPlace({super.key});

  @override
  State<BlogWeddingPlace> createState() => _BlogWeddingPlaceState();
}

class _BlogWeddingPlaceState extends State<BlogWeddingPlace> {
  @override
