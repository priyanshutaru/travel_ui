...
class BlogPhotography extends StatefulWidget {
  const BlogPhotography({super.key});

  @override
  State<BlogPhotography> createState() => _BlogPhotographyState();
}

class _BlogPhotographyState extends State<BlogPhotography> {
  @override
