...
class BlogPhotoshoot extends StatefulWidget {
  const BlogPhotoshoot({super.key});

  @override
  State<BlogPhotoshoot> createState() => _BlogPhotoshootState();
}

class _BlogPhotoshootState extends State<BlogPhotoshoot> {
  @override
