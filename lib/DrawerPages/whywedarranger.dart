              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      // color: Colors.green
                      image: DecorationImage(image: NetworkImage("https://wedarranger.com/assets/img/booking_online.png"),fit: BoxFit.cover),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(75),
                      //color: Colors.green
                      image: DecorationImage(image: NetworkImage("https://wedarranger.com/assets/img/gif.png"),fit: BoxFit.cover),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(75),
                      // color: Colors.green
                       image: DecorationImage(image: NetworkImage("https://wedarranger.com/assets/img/search_vendor.png"),fit: BoxFit.cover),
                      ),
                ),
                Text(
                  "Availability",
                ...
                Text("Check instant availability of vendors online without wasting time."),
                SizedBox(height: 5,),
                Container(
                  height: 150,
                  width: 150,
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(75),
                      // color: Colors.green
                       image: DecorationImage(image: NetworkImage("https://wedarranger.com/assets/img/hands.png"),fit: BoxFit.cover),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(75),
                      // color: Colors.green
                       image: DecorationImage(image: NetworkImage("https://wedarranger.com/assets/img/location.png"),fit: BoxFit.cover),
